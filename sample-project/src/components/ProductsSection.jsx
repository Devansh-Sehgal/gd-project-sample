import { Package, BarChart, ShoppingCart, CreditCard } from 'lucide-react';
...
const ProductsSection = () => {
  ...
  return (
    <section id="products" className="py-10 cursor-pointer bg-muted/50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {products.map((product, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all service-card duration-300"
            >
